...
describe.only("API", () => {
  ...
  describe("Utils", () => {
    it("should set, get, list cache", () => {
      ...
      expect(Config.get("__test__")).toBe(undefined);

      Config.set("__test__", "some_value");
      expect(Config.get("__test__")).toEqual("some_value");

      Config.set("__test__", { testingValue: "someTestingValue" });
      expect(Config.get("__test__")).toEqual({
        testingValue: "someTestingValue",
      });

      Config.set("__test__", [{ some: "who" }]);
      Config.set("__test__", []);
      expect(Config.get("__test__")).toEqual([]);
    });
  });
